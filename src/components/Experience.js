...
const Details = ({ position, company, companyLink, time, address, work }) => {
    ...
    return <li ref={ref} className="my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col items-center justify-between">
        ...
        >
            <h3 className="capitalize font-bold text-2xl">{position}&nbsp;<a href={companyLink} className="text-primary dark:text-primaryDark capitalize" target="_blank">@{company}</a></h3>
  ...
  return (
      <div className='my-64'>
          ...
          <div ref={ref} className="w-[75%] mx-auto relative">
              <motion.div className="absolute left-9 top-[5px] w-[4px] h-full bg-dark dark:bg-light origin-top"
              ...
              <ul className="w-full flex flex-col items-start justify-between ml-4">
                  ...
                  />
                  <Details
                      position="Software Software Developer Intern"
                      company={"Microsoft"}
                      companyLink={"https://www.microsoft.com"}
                      time={"2020-Summer 2019"}
                      address={"Redmond, WA."}
