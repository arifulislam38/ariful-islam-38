                ...
                <Layout className='pt-16'>
                    ...
                    <div className='grid w-full grid-cols-8 sm:gap-8 gap-16'>
                        ...
                        <div className='col-span-3 xl:col-span-4 md:col-span-8 relative h-max rounded-2xl border-2 border-solid border-dark dark:border-light bg-light dark:bg-dark p-8 md:order-1'>
                            ...
                            <Image src={profilePic} alt='ariful islam' className='w-full h-auto rounded-2xl'
                            priority
                            sizes='(max-width:768px) 100vw, (max-width:1200px) 50vw, 33vw'
                            />
                        </div>
                        <div className='col-span-2 xl:col-span-8 xl:flex-row flex flex-col items-end xl:items-center justify-between md:order-3'>
