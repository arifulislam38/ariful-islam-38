          ...
          <div className='flex items-center justify-between w-full '>
            ...
            <div className='w-1/2 flex flex-col items-center self-center'>
              ...
              <div className='flex items-center self-start mt-2'>
                ...
                <Link href="mailto:mdarifulislam0238@gmail.com" target='_blank' className='ml-4 text-lg font-medium capitalize text-dark underline underline-offset-4 dark:text-light'>Contact</Link>
              </div>
            </div>
          </div>
        </Layout>
